                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Pain Relief</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">245</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2025-06-15</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              <div className="text-sm font-medium text-gray-900">Amoxicillin 250mg</div>
                              <div className="text-sm text-gray-500">Capsule</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Antibiotic</td>
